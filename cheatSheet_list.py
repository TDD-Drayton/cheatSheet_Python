...
a_list=["Cisco","Arista","Juniper","Nokia","Huawei","Ecrisson","Motorola","Generic Switch","Imported Switch","Space Switch","Custom Switch", "Home Switch", "Office Switch","Secret Switch"]
...
### ['Ecrisson', 'Motorola', 'Generic Switch', 'Imported Switch', 'Space Switch', 'Custom Switch', 'Home Switch', 'Office Switch', 'Secret Switch']
...
### ['Cisco', 'Arista', 'Juniper', 'Nokia', 'Huawei', 'Ecrisson', 'Motorola', 'Generic Switch', 'Imported Switch', 'Space Switch']
...
### ['Ecrisson', 'Motorola', 'Generic Switch', 'Imported Switch', 'Space Switch', 'Custom Switch', 'Home Switch', 'Office Switch']
a_list[-5:] #returns the last 5 elements in the list
### ['Space Switch', 'Custom Switch', 'Home Switch', 'Office Switch', 'Secret Switch']
a_list[:-5] #returns the list minus its last 5 elements
### ['Cisco', 'Arista', 'Juniper', 'Nokia', 'Huawei', 'Ecrisson', 'Motorola', 'Generic Switch', 'Imported Switch']
a_list[::2] #adds a third element called step; skips every second element of the list
### ['Cisco', 'Juniper', 'Huawei', 'Motorola', 'Imported Switch', 'Custom Switch', 'Office Switch']
a_list[::-1] #returns a_list's elements in reverse order
### ['Secret Switch', 'Office Switch', 'Home Switch', 'Custom Switch', 'Space Switch', 'Imported Switch', 'Generic Switch', 'Motorola', 'Ecrisson', 'Huawei', 'Nokia', 'Juniper', 'Arista', 'Cisco']
